...
def cost_rank():
    ...
    dict_keys_df["Payment Difference"] = dict_keys_df["2013_earnings_6_yrs_after_entry_median"]-dict_keys_df["2013_cost_attendance_academic_year"]

    dict_keys_df = dict_keys_df.sort_values(by = ["Payment Difference"], ascending=False)
    
    new_dict_keys = {}

    school_names = dict_keys_df.head(100)["school_name"].values.tolist()
    payment_differences = dict_keys_df.head(100)["Payment Difference"].values.tolist()
